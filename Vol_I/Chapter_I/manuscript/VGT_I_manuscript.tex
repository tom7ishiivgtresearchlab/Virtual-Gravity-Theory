...
\begin{figure*}[t]
\centering
\includegraphics[width=0.85\textwidth]{../figures/VGT_I_fig1_HzFit.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.95\textwidth]{../figures/VGT_I_fig2_Corner.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.48\textwidth]{../figures/VGT_I_fig3_GConstraint.pdf}
...
%    - VGT_I_fig1_HzFit.pdf
%    - VGT_I_fig2_Corner.pdf
%    - VGT_I_fig3_GConstraint.pdf
%
% 2. Compile twice for proper cross-references:
%    pdflatex VGT_I_manuscript.tex
%    pdflatex VGT_I_manuscript.tex
%
% 3. For BibTeX (if converting to .bib file):
%    pdflatex VGT_I_manuscript.tex
%    bibtex VGT_I_manuscript
%    pdflatex VGT_I_manuscript.tex
%    pdflatex VGT_I_manuscript.tex
%
